...
{
    /// <summary>Creates a DIS v7 IFFPdu with its wire discriminator fields initialized.</summary>
    public IFFPdu() => Initialize(28, 6);
...
{
    /// <summary>Creates a DIS v7 SEESPdu with its wire discriminator fields initialized.</summary>
    public SEESPdu() => Initialize(30, 6);
