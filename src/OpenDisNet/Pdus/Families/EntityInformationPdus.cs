...
{
    /// <summary>Creates a DIS v7 AttributePdu with its wire discriminator fields initialized.</summary>
    public AttributePdu() => Initialize(72, 1);
...
{
    /// <summary>Creates a DIS v7 CollisionElasticPdu with its wire discriminator fields initialized.</summary>
    public CollisionElasticPdu() => Initialize(66, 1);
...
{
    /// <summary>Creates a DIS v7 CollisionPdu with its wire discriminator fields initialized.</summary>
    public CollisionPdu() => Initialize(4, 1);
...
{
    /// <summary>Creates a DIS v7 EntityStatePdu with its wire discriminator fields initialized.</summary>
    public EntityStatePdu() => Initialize(1, 1);
...
{
    /// <summary>Creates a DIS v7 EntityStateUpdatePdu with its wire discriminator fields initialized.</summary>
    public EntityStateUpdatePdu() => Initialize(67, 1);
